...
final class MainViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        sideMenuViewController.view.snp.makeConstraints { make in
    ...
    @objc public func revealSideMenu() {
...
private extension MainViewController {
    func setupView() {
        ...
        if self.revealSideMenuOnTop {
            sideMenuRevealWidth = view.frame.width * 0.7
...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 1:
            // BRAWLERS
            showViewController(viewController: BrawlersViewController.self)
        case 2:
            // MAPS
            showViewController(viewController: MapsViewController.self)
        case 3:
            // GAME MODES
            showViewController(viewController: GameModesViewController.self)
        default:
            break
        }
    ...
    func showViewController<T: UIViewController>(viewController: T.Type) -> () {
        ...
        let vc = UINavigationController(rootViewController: T())
        vc.view.tag = 99
...
extension UIViewController {
    // With this extension we can access the MainViewController from the child view controllers.
